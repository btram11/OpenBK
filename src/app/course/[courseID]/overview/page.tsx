...
export default function Page() {
  ...
  return (
    <section className="flex flex-col justify-center items-start pt-4 pb-[200px] pr-11 pl-24 w-full text-2xl text-black max-md:px-5 max-md:max-w-full">
      <div className="flex flex-col justify-center p-4 max-w-full rounded-xl border border-solid border-black border-opacity-30 w-[775px]" role="region" aria-labelledby="learning-objectives-title">
        <h2 id="learning-objectives-title" className="leading-none font-bold gap-4">What you will learn</h2>
        
        <div className="flex flex-wrap gap-10 justify-between items-center mt-2.5 gap-4 max-w-full text-base text-black w-[587px]">

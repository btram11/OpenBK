  ...
  return (
    <div className="flex flex-col justify-center px-2.5 mt-2.5 w-full">
      <div className="flex flex-wrap gap-2.5 items-center w-full ">
        ...
        <div className="flex flex-wrap flex-1 shrink gap-10 justify-between items-center self-stretch my-auto basis-0 min-w-[240px] ">
      ...
      <div className="mt-2.5 text-sm tracking-wide leading-5 text-justify text-black ">
        {review.comment}
      </div>
    </div>
  );
...
export default function Page() {
  ...
  return (
    <div
      id="body"
      className="flex flex-col justify-center items-start pt-4 pb-[200px] w-full max-md:px-5 "
      role="region"
      aria-label="Product Reviews"
    >
      <div className="flex flex-col justify-center p-4 max-w-full rounded-xl border border-solid border-black border-opacity-30 w-full">
        <div className="flex overflow-hidden flex-wrap gap-5 items-center px-2.5 pb-2.5 w-full border-b border-black border-opacity-50 ">
          <div className="flex flex-col justify-center items-center self-stretch p-1.5 my-auto">
            ...
            <div
              id="reviews"
              className="text-xs tracking-wide leading-none text-black"
            >
              123 reviews
            </div>
          </div>

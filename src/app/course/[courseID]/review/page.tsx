...
export default function Page() {
    ...
    return (
        <div id="body" className="flex flex-col justify-center items-start pt-4 pb-[200px] pr-11 pl-24 w-full max-md:px-5 max-md:max-w-full" role="region" aria-label="Product Reviews">
          <div className="flex flex-col justify-center p-4 max-w-full rounded-xl border border-solid border-black border-opacity-30 w-[849px]">

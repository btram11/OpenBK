...
export default function Page() {
  return (
    <main>
        <section className="flex flex-col justify-center items-start py-14 pr-20 pl-20 w-full bg-gradient-to-r from-sky-500 to-indigo-100 min-h-[294px] max-md:px-5 max-md:max-w-full">
